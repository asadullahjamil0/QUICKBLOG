    ...
    return (
        <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
            <div className='text-center mt-20 mb-8'>
                ...
                <h1 className='text-5xl sm:text6x1 font-semibold sm:leading-16 text-gray-700'>Your Own <span className='text-primary'>Blogging</span> <br />platform</h1>
                ...
                <form className='flex justify-between max-w-lg max-sm:scale-75 mx-auto border border-gray-300 bg-white rounded overflow-hidden'>
                    <input type="text" name="" id="" placeholder='search for blogs' required className='w-full pl-4 outline-none' />
